...
source("/gpfs/data/im-lab/nas40t2/hwheeler/ancestry-px/PredictDB_Pipeline_GTEx_v7/model_training/scripts/gtex_v7_nested_cv_elnet_subset_n_genes.R")
...
prefix2 <- "FHS_2019-05-24_LDpruned_" %&% Nk %&% "PFs_subset" %&% gene_subset
