...
snp_annot_file <- mydir %&% "genotype/FHS_2019-05-01/chr" %&% chrom %&% "_snp_annot_dbSNP151.txt"
gene_annot_file <- mydir %&% "expression/gencode.v19.genes.patched_contigs.parsed.txt"
genotype_file <- mydir %&% "genotype/FHS_2019-05-01/chr" %&% chrom %&% "_dosage_maf01.r2_8.dbSNP151.txt.gz"
expression_file <- mydir %&% "expression/FHS/FHS_adjEXP_peer_Nk-" %&% Nk %&% ".txt"
covariates_file <- mydir %&% "covariates/FHS_2019-04-02/FHS_eur_10_gt_PCs_covariates.txt"
prefix1 <- "FHS_nested_cv"
prefix2 <- "FHS_nested_cv_" %&% Nk %&% "PFs"
