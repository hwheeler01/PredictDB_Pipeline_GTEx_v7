...
expression_file <- mydir %&% "expression/FHS_2019-05-16/ERAP2_FHS_adjEXP_peer_Nk-" %&% Nk %&% ".txt"
covariates_file <- mydir %&% "covariates/FHS_2019-04-02/FHS_eur_10_gt_PCs_covariates.txt"
prefix1 <- "ERAP2_FHS_nested_cv_LDpruned"
prefix2 <- "ERAP2_FHS_nested_cv_LDpruned_" %&% Nk %&% "PFs"
